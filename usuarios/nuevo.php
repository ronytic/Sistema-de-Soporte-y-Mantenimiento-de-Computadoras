...
<div class="prefix_2 grid_4 suffix_3 imagenfondo">
    ...
    <fieldset class="contenido">
        ...
        <table class="tablareg">
            ...
            <tr>
            	<td><?php campos("Lugar","lugar","text","",0,array("required"=>"required","size"=>30));?></td>
                <td><?php campos("Unidad","unidad","text","",0,array("size"=>30));?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php campos("Nivel","nivel","select",array("2"=>"Personal Técnico","3"=>"Usuario"));?></td>
            </tr>
