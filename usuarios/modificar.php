    	...
    	<div class="prefix_3 grid_4 suffix_3 imagenfondo">
			<fieldset>
				...
				<table class="tablareg">
                    ...
                    <tr>
                        <td><?php campos("Lugar","lugar","text",$usu['lugar'],0,array("required"=>"required","size"=>30));?></td>
                        <td><?php campos("Unidad","unidad","text",$usu['unidad'],0,array("size"=>30));?></td>
                    </tr>
                    <tr>
            	...
            	<td><?php campos("Celular","celular","text",$usu['celular'],0,array("required"=>"required","size"=>30));?></td>
                    ...
                    <tr>
						...
						<td><?php campos("Nivel","nivel","select",array("2"=>"Personal Técnico","3"=>"Usuario"),"","",$usu['nivel']);?></td>
					</tr>
					<tr>
