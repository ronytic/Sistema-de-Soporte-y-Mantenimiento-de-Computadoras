...
$pr=array_shift($programas->mostrar($id));
			...
			<fieldset>
				...
				<table class="tablareg">
                   ...
                   <?php /*<tr>
                        ...
                        <?php
							if($pr['imagen']!=""){
							?><a href="../../imagenes/sistemasoperativos/<?php echo $pr['imagen']?>" target="_blank"><img src="../../imagenes/sistemasoperativos/<?php echo $pr['imagen']?>" width="150"></a><?php	
							}
						?>
                        </td>
					</tr>
